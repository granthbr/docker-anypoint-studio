...
LABEL Description="MuleSoft Anypoint Studio 7.5"
...
RUN   echo 'Downloading Studio'  && \
      wget -nv --show-progress --progress=bar:force:noscroll https://mule-studio.s3.amazonaws.com/7.5.0-GA/AnypointStudio-$STUDIO_VERSION-linux64.tar.gz -O /tmp/studio.tar.gz \ 
...
USER   mule
ENV    HOME /home/mule
WORKDIR /home/muleADD docker-entrypoint.sh /home/mule/
#Run   chmod 775 /home/mule/docker-entrypoint.sh && \
